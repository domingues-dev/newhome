//
//  WalletButtonCollectionViewCell.swift
//  newhome
//
...
class WalletButtonCollectionViewCell: UICollectionViewCell {
    ...
    lazy var addressButtonView: ProfileButtonView = {
        ...
        sb.icon.iconImageView.image = AppProfileIcons.walletIcon
        sb.label.text = "My Wallet"
